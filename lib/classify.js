...
export function classifyImage(image) {
  ...
  const darkPanes = interiorBlack.rectangular >= 2 && interiorBlack.total >= 0.1;
  const multiPane =
    darkPanes ||
  ...
  if ((closedBlack && border.darkFrac >= 0.15) || darkPanes || lightGrid || (multiPane && border.whiteFrac < 0.55)) {
