...
function ringHoleCount(lum, w, h, box) {
  ...
  let best = Math.max(
    ...
    owlHoleCount(lum, w, h, cx, cy, rxMax, ryMax),
    penguinHoleCount(lum, w, h, cx, cy, rxMax, ryMax),
    dolphinHoleCount(lum, w, h, cx, cy, rxMax, ryMax),
    whaleHoleCount(lum, w, h, cx, cy, rxMax, ryMax),
    sharkHoleCount(lum, w, h, cx, cy, rxMax, ryMax),
    turtleHoleCount(lum, w, h, cx, cy, rxMax, ryMax),
    octopusHoleCount(lum, w, h, cx, cy, rxMax, ryMax),
    crabHoleCount(lum, w, h, cx, cy, rxMax, ryMax),
    lobsterHoleCount(lum, w, h, cx, cy, rxMax, ryMax),
    shrimpHoleCount(lum, w, h, cx, cy, rxMax, ryMax),
    seahorseHoleCount(lum, w, h, cx, cy, rxMax, ryMax),
    jellyfishHoleCount(lum, w, h, cx, cy, rxMax, ryMax),
    starfishHoleCount(lum, w, h, cx, cy, rxMax, ryMax),
    shellHoleCount(lum, w, h, cx, cy, rxMax, ryMax),
    snailHoleCount(lum, w, h, cx, cy, rxMax, ryMax),
    frogHoleCount(lum, w, h, cx, cy, rxMax, ryMax),
    lizardHoleCount(lum, w, h, cx, cy, rxMax, ryMax),
    snakeHoleCount(lum, w, h, cx, cy, rxMax, ryMax),
    crocodileHoleCount(lum, w, h, cx, cy, rxMax, ryMax),
    elephantHoleCount(lum, w, h, cx, cy, rxMax, ryMax),
    giraffeHoleCount(lum, w, h, cx, cy, rxMax, ryMax),
    zebraHoleCount(lum, w, h, cx, cy, rxMax, ryMax),
  );
  if (Math.max(rxMax, ryMax) / Math.max(1, Math.min(rxMax, ryMax)) < 1.25) {
    for (const a of [1.35, 1.65, 2.0]) {
      const nWide = Math.max(
        ...
        owlHoleCount(lum, w, h, cx, cy, rxMax, rxMax / a),
        penguinHoleCount(lum, w, h, cx, cy, rxMax, rxMax / a),
        dolphinHoleCount(lum, w, h, cx, cy, rxMax, rxMax / a),
        whaleHoleCount(lum, w, h, cx, cy, rxMax, rxMax / a),
        sharkHoleCount(lum, w, h, cx, cy, rxMax, rxMax / a),
        turtleHoleCount(lum, w, h, cx, cy, rxMax, rxMax / a),
        octopusHoleCount(lum, w, h, cx, cy, rxMax, rxMax / a),
        crabHoleCount(lum, w, h, cx, cy, rxMax, rxMax / a),
        lobsterHoleCount(lum, w, h, cx, cy, rxMax, rxMax / a),
        shrimpHoleCount(lum, w, h, cx, cy, rxMax, rxMax / a),
        seahorseHoleCount(lum, w, h, cx, cy, rxMax, rxMax / a),
        jellyfishHoleCount(lum, w, h, cx, cy, rxMax, rxMax / a),
        starfishHoleCount(lum, w, h, cx, cy, rxMax, rxMax / a),
        shellHoleCount(lum, w, h, cx, cy, rxMax, rxMax / a),
        snailHoleCount(lum, w, h, cx, cy, rxMax, rxMax / a),
        frogHoleCount(lum, w, h, cx, cy, rxMax, rxMax / a),
        lizardHoleCount(lum, w, h, cx, cy, rxMax, rxMax / a),
        snakeHoleCount(lum, w, h, cx, cy, rxMax, rxMax / a),
        crocodileHoleCount(lum, w, h, cx, cy, rxMax, rxMax / a),
        elephantHoleCount(lum, w, h, cx, cy, rxMax, rxMax / a),
        giraffeHoleCount(lum, w, h, cx, cy, rxMax, rxMax / a),
        zebraHoleCount(lum, w, h, cx, cy, rxMax, rxMax / a),
          );
      const nTall = Math.max(
        ...
        owlHoleCount(lum, w, h, cx, cy, ryMax / a, ryMax),
        penguinHoleCount(lum, w, h, cx, cy, ryMax / a, ryMax),
        dolphinHoleCount(lum, w, h, cx, cy, ryMax / a, ryMax),
        whaleHoleCount(lum, w, h, cx, cy, ryMax / a, ryMax),
        sharkHoleCount(lum, w, h, cx, cy, ryMax / a, ryMax),
        turtleHoleCount(lum, w, h, cx, cy, ryMax / a, ryMax),
        octopusHoleCount(lum, w, h, cx, cy, ryMax / a, ryMax),
        crabHoleCount(lum, w, h, cx, cy, ryMax / a, ryMax),
        lobsterHoleCount(lum, w, h, cx, cy, ryMax / a, ryMax),
        shrimpHoleCount(lum, w, h, cx, cy, ryMax / a, ryMax),
        seahorseHoleCount(lum, w, h, cx, cy, ryMax / a, ryMax),
        jellyfishHoleCount(lum, w, h, cx, cy, ryMax / a, ryMax),
        starfishHoleCount(lum, w, h, cx, cy, ryMax / a, ryMax),
        shellHoleCount(lum, w, h, cx, cy, ryMax / a, ryMax),
        snailHoleCount(lum, w, h, cx, cy, ryMax / a, ryMax),
        frogHoleCount(lum, w, h, cx, cy, ryMax / a, ryMax),
        lizardHoleCount(lum, w, h, cx, cy, ryMax / a, ryMax),
        snakeHoleCount(lum, w, h, cx, cy, ryMax / a, ryMax),
        crocodileHoleCount(lum, w, h, cx, cy, ryMax / a, ryMax),
        elephantHoleCount(lum, w, h, cx, cy, ryMax / a, ryMax),
        giraffeHoleCount(lum, w, h, cx, cy, ryMax / a, ryMax),
        zebraHoleCount(lum, w, h, cx, cy, ryMax / a, ryMax),
      );
