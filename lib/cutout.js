...
function stampFrogFromHoles(holes) {
  ...
  if (holesAtBoxCorners(holes) || sidedness(holes, 8) >= 8) return null;
  if (stampDiskFromHoles(holes) || stampHexagonFromHoles(holes) || stampOctagonFromHoles(holes) || stampPentagonFromHoles(holes) || stampTriangleFromHoles(holes)) return null;
  if (stampFlowerFromHoles(holes) || stampHeartFromHoles(holes) || stampCloverFromHoles(holes) || stampTeardropFromHoles(holes) || stampCloudFromHoles(holes) || stampShellFromHoles(holes) || stampSeahorseFromHoles(holes) || stampJellyfishFromHoles(holes) || stampSnailFromHoles(holes) || stampLizardFromHoles(holes)) return null;
  let x0 = Infinity;
  let y0 = Infinity;
  let x1 = -Infinity;
  let y1 = -Infinity;
