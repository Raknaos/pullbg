...
export function stampCut(image) {
  ...
  const paintPiece = (localHoles, hexLocal, octLocal, pentLocal, triLocal, starLocal, heartLocal, crescentLocal, teardropLocal, shieldLocal, crossLocal, arrowLocal, cloudLocal, cloverLocal, flowerLocal, butterflyLocal, leafLocal, fishLocal, birdLocal, catLocal, dogLocal, rabbitLocal, squirrelLocal, foxLocal, bearLocal, horseLocal, pigLocal, cowLocal, sheepLocal, goatLocal, roosterLocal, duckLocal, gooseLocal, turkeyLocal, swanLocal, peacockLocal, owlLocal, penguinLocal, dolphinLocal, whaleLocal, sharkLocal, turtleLocal, octopusLocal, crabLocal, lobsterLocal, shrimpLocal, seahorseLocal, jellyfishLocal, starfishLocal, shellLocal, snailLocal, frogLocal, lizardLocal, snakeLocal, crocodileLocal, elephantLocal, giraffeLocal, self) => {
