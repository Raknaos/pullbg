...
export function fastCut(image) {
  ...
  else if (guess.interior && guess.mode === "noir") winner = pack(punchInterior(floodBlack(image, 26)), "écran");
  else if (guess.interior) winner = pack(punchInterior(image), "page");
